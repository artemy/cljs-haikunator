...
var G__14151 = o;
goog.object.set(G__14151,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__14155 = o;
goog.object.set(G__14155,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__14157__i < G__14157__a.length) {G__14157__a[G__14157__i] = arguments[G__14157__i + 0]; ++G__14157__i;}
  args = new cljs.core.IndexedSeq(G__14157__a,0,null);
} 
...
var G__14159 = props;
var G__14159__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14159,cljs.core.cst$kw$id,id):G__14159);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14159__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__14159__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__14160 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14160,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__14160;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__14161){
var map__14162 = p__14161;
var map__14162__$1 = (((((!((map__14162 == null))))?(((((map__14162.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14162.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14162):map__14162);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14162__$1,cljs.core.cst$kw$on_DASH_write);
...
return (jsprops.onChange = (function (p1__14164_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__14164_SHARP_);
}));
} else {
return null;
}
...
var vec__14167 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14167,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14167,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14167,(2),null);
...
var temp__5724__auto___14171 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___14171 == null)){
} else {
var key_14172 = temp__5724__auto___14171;
(jsprops.key = key_14172);
}
...
var temp__5724__auto___14173 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___14173 == null)){
} else {
var key_14174 = temp__5724__auto___14173;
(jsprops.key = key_14174);
}
...
var G__14175 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__14175) : reagent.impl.template.as_element.call(null,G__14175));
} else {
var temp__5724__auto___14176 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5724__auto___14176 == null)){
} else {
var key_14177 = temp__5724__auto___14176;
(jsprops.key = key_14177);
}
...
var G__14179 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__14179)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__14179)){
return x;
} else {
...
var len__4736__auto___14182 = arguments.length;
var i__4737__auto___14183 = (0);
while(true){
if((i__4737__auto___14183 < len__4736__auto___14182)){
args__4742__auto__.push((arguments[i__4737__auto___14183]));

var G__14184 = (i__4737__auto___14183 + (1));
i__4737__auto___14183 = G__14184;
continue;
} else {
}
break;
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14181,seq14180__$1);
}));
...
var ctx = ({});
var vec__14189 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14189,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14189,(1),null);
...
var G__14192 = (cljs.core.count(argv) - first_child);
switch (G__14192) {
case (0):
...
break;
case (1):
var G__14193 = component;
var G__14194 = jsprops;
var G__14195 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__14193,G__14194,G__14195);
