...
if((i < len)){
var k = (ks[i]);
var G__14106 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__14107 = (i + (1));
m = G__14106;
i = G__14107;
continue;
...
var temp__5722__auto__ = p.argv;
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__14108 = p.children;
return reagent.impl.component.global$module$react.Children.toArray(G__14108);
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__14110 = c;
var G__14110__$1 = (((G__14110 == null))?null:G__14110.prototype);
if((G__14110__$1 == null)){
return null;
} else {
return G__14110__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__14112 = c;
var G__14112__$1 = (((G__14112 == null))?null:G__14112.prototype);
if((G__14112__$1 == null)){
return null;
} else {
return G__14112__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__14116__delegate = function (args){
var G__14114 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__14114) : reagent.impl.component.as_element.call(null,G__14114));
};
...
while (G__14117__i < G__14117__a.length) {G__14117__a[G__14117__i] = arguments[G__14117__i + 0]; ++G__14117__i;}
  args = new cljs.core.IndexedSeq(G__14117__a,0,null);
} 
return G__14116__delegate.call(this,args);};
...
return G__14116__delegate(args);
});
...
var G__14120 = c;
var G__14120__$1 = (((G__14120 == null))?null:G__14120.constructor);
if((G__14120__$1 == null)){
return null;
} else {
return G__14120__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__14121 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__14122 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__14122);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__14121);
}});
...
var c = this;
var G__14126_14128 = goog.object.get(c,"cljsRatom");
if((G__14126_14128 == null)){
} else {
reagent.ratom.dispose_BANG_(G__14126_14128);
}
...
var renders_14129 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_14130 = cljs.core.first(cljs.core.vals(renders_14129));
...
if((cljs.core.count(renders_14129) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_14129))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_14130)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_14130], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__14131 = o;
goog.object.set(G__14131,cljs.core.name(k),v);
